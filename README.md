...
It mean that websites, web apps, and web tools are properly engineered so that even people with disabilties can use them.

2. Talk about 3 different things you can do to ensure your website is accessible. 
Filling it alt attributes in images, responsive design, and keyboard input if the user cannot use a mouse.

3. How would you explain the concept of a variable to someone new to programming?
A variable stores data to varying degrees in the memory of a program. Calling the variable by name points to its place in memory.

4. What is the purpose of using functions in code?
Function keep code modular and also allows it to be resuable throughtout one file and across multiple others.
